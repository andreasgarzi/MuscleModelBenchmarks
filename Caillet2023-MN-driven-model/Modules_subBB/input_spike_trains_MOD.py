...
def input_spike_trains_func(Input_MU_pop, Nb_MN, Firing_times_sim, exp_disch_times, fs):
    ...
    if Input_MU_pop=='400': 
        sp_matrix = Firing_times_sim  #simulated virtual MN population
        n=0
        ...
        Nr=len(sp_matrix) #Number of firing MNs within the N pop
    
    elif Input_MU_pop=='Nr': 
        sp_matrix = exp_disch_times/fs # samples --> seconds
        Nr = Nb_MN    
