...
#plt.plot(eps_T*100, f_T3, 'g', label = r'$\epsilon^T_0$ = 6%')
...
#plt.xlabel(r'$\epsilon^T$ [%]', weight='bold', fontsize=17)
#plt.ylabel('$\overline {F^T}$', weight='bold', fontsize=17)
#plt.grid()
...
# plt.rcParams['figure.dpi'] = 250
# plt.plot(l_M_PE, f_PE0, 'm', label='k1 = 5, k2 = 0.6')
...
# plt.xlabel('$\overline {L^M}$', weight='bold', fontsize=17)
# plt.ylabel('$\overline {F^M}$', weight='bold', fontsize=17)
# plt.grid()
...
plt.rcParams['figure.dpi'] = 250
plt.plot(l_M, fl[0,:,0], color=cg1[0], label = 'a = 0.2')
plt.plot(l_M, fl[1,:,0], color=cg1[1], label = 'a = 0.4')
plt.plot(l_M, fl[2,:,0], color=cg1[2], label = 'a = 0.6')
plt.plot(l_M, fl[3,:,0], color=cg1[3], label = 'a = 0.8')
plt.plot(l_M, fl[4,:,0], color=cg1[4], label = 'a = 1.0')
...
plt.xlabel('$\overline {L^M}$', weight='bold', fontsize=17)
plt.ylabel('$\overline {F^M_l}$', weight='bold', fontsize=17)
plt.grid()
plt.legend(fontsize=15)
#plt.title('F-L relationship', weight='bold', fontsize=17)
...
#plt.plot(v_M, fv[0,:,0], color=cg12[0], label = 'a = 0.2, slow')
#plt.plot(v_M, fv[1,:,0], color=cg12[1], label = 'a = 0.4')
plt.plot(v_M, fv[2,:,0], color=cg12[0], label = 'a = 0.5, slow')
#plt.plot(v_M, fv[3,:,0], color=cg12[3], label = 'a = 0.8')
plt.plot(v_M, fv[4,:,0], color=cg12[2], label = 'a = 1.0, slow')

#plt.plot(v_M, fv[0,:,1], color=cg1[0], label = 'a = 0.2, fast')
#plt.plot(v_M, fv[1,:,1], color=cg12[1], label = 'a=0.4, fast')
plt.plot(v_M, fv[2,:,1], color=cg1[2], label = 'a = 0.5, fast')
#plt.plot(v_M, fv[3,:,1], color=cg12[3], label = 'a=0.8, fast')
plt.plot(v_M, fv[4,:,1], color=cg1[4], label = 'a = 1.0, fast')
...
plt.xlabel('$\overline {V^M}$', weight='bold', fontsize=17)
plt.ylabel('$\overline {F^M_v}$', weight='bold', fontsize=17)
plt.grid()
#plt.ylim((0.4, 1.8))
plt.xlim((-1.2,1.2))
plt.legend(fontsize=15, loc='lower right')
#plt.title('F-V relationship ($\overline {L^M}$ = 1)', weight='bold', fontsize=17)
