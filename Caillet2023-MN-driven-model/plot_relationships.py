...
plt.subplot(2,2,2)
plt.plot(l_M_PE, f_PE0, 'k--', label='k1 = 5, k2 = 0.6 (Thelen 2003)')
plt.plot(l_M_PE, f_PE1, color=cg2[0], label='k1 = 5, k2 = 0.8') 
plt.plot(l_M_PE, f_PE2, color=cg2[1], label='k1 = 5, k2 = 1.0') 
plt.plot(l_M_PE, f_PE3, color=cg2[2], label='k1 = 5, k2 = 1.2') 
plt.plot(l_M_PE, f_PE4, color=cg3[0], label='k1 = 4, k2 = 0.6') 
plt.plot(l_M_PE, f_PE5, color=cg3[1], label='k1 = 3, k2 = 0.6') 
plt.plot(l_M_PE, f_PE6, color=cg3[2], label='k1 = 2, k2 = 0.6') 
