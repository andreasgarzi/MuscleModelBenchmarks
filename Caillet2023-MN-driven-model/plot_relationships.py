...
for i in range(points):
    ...
    f_PE0[i] = PEE_force(l_M[i], 0)
    f_PE1[i] = PEE_force(l_M[i], 1)
    f_PE2[i] = PEE_force(l_M[i], 2)
    f_PE3[i] = PEE_force(l_M[i], 3)
    f_PE4[i] = PEE_force(l_M[i], 4)
    f_PE5[i] = PEE_force(l_M[i], 5)
    f_PE6[i] = PEE_force(l_M[i], 6)
...
plt.plot(eps_T*100, f_T2, color=cgt[2], linestyle = 'dashed', label = r'$\epsilon^T_0$ = 3.3% (Thelen 2003)')
...
plt.subplot(2,2,2)
plt.plot(l_M, f_PE0, 'k--', label='k1 = 5, k2 = 0.6 (Thelen 2003)')
plt.plot(l_M, f_PE1, color=cg2[0], label='k1 = 5, k2 = 0.8') 
plt.plot(l_M, f_PE2, color=cg2[1], label='k1 = 5, k2 = 1.0') 
plt.plot(l_M, f_PE3, color=cg2[2], label='k1 = 5, k2 = 1.2') 
plt.plot(l_M, f_PE4, color=cg3[0], label='k1 = 4, k2 = 0.6') 
plt.plot(l_M, f_PE5, color=cg3[1], label='k1 = 3, k2 = 0.6') 
plt.plot(l_M, f_PE6, color=cg3[2], label='k1 = 2, k2 = 0.6') 
...
plt.plot(v_M, fv[2,:,0], color=cg2[1], label = 'a = 0.6, fast')
plt.plot(v_M, fv[4,:,0], color=cg2[2], label = 'a = 1.0, fast')
plt.plot(v_M, fv[0,:,1], color=cg3[0], label = 'a = 0.2, slow')
plt.plot(v_M, fv[2,:,1], color=cg3[1], label = 'a = 0.6, slow')
plt.plot(v_M, fv[4,:,1], color=cg3[2], label = 'a = 1.0, slow')
